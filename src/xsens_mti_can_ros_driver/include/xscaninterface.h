...
private:
    ...
    const std::map<uint32_t, std::string> frame_id_default_map_ = {
        {error_default_frame_id_, "error_frame_id"},
        {warning_default_frame_id_, "warning_frame_id"},
        {sample_time_default_frame_id_, "sample_time_frame_id"},
        {group_counter_default_frame_id_, "group_counter_frame_id"},
        {status_word_default_frame_id_, "status_word_frame_id"},
        {quaternion_default_frame_id_, "quaternion_frame_id"},
        {delta_v_default_frame_id_, "delta_v_frame_id"},
        {rate_of_turn_default_frame_id_, "rate_of_turn_frame_id"},
        {delta_q_default_frame_id_, "delta_q_frame_id"},
        {acceleration_default_frame_id_, "acceleration_frame_id"},
        {free_acceleration_default_frame_id_, "free_acceleration_frame_id"},
        {rate_of_turn_hr_default_frame_id_, "rate_of_turn_hr_frame_id"},
        {acceleration_hr_default_frame_id_, "acceleration_hr_frame_id"},
        {magnetic_field_default_frame_id_, "magnetic_field_frame_id"},
        {temperature_default_frame_id_, "temperature_frame_id"},
        {barometric_pressure_default_frame_id_, "barometric_pressure_frame_id"},
        {utc_default_frame_id_, "utc_frame_id"},
        {euler_angles_default_frame_id_, "euler_angles_frame_id"},
        {lat_lon_default_frame_id_, "lat_lon_frame_id"},
        {altitude_ellipsoid_default_frame_id_, "altitude_ellipsoid_frame_id"},
        {position_ecef_x_default_frame_id_, "position_ecef_x_frame_id"},
        {position_ecef_y_default_frame_id_, "position_ecef_y_frame_id"},
        {position_ecef_z_default_frame_id_, "position_ecef_z_frame_id"},
        {velocity_default_frame_id_, "velocity_frame_id"},
        {gnss_receiver_status_default_frame_id_, "gnss_receiver_status_frame_id"},
        {gnss_receiver_dop_default_frame_id_, "gnss_receiver_dop_frame_id"},
    };
